...
#ifndef OPENGLTEST_MODEL3DS_H
#define OPENGLTEST_MODEL3DS_H
...
private:
    ...
    double m_specialTransformTable[1000];  // tablica pomocnicza do transformacji specjalnych, ma r�zne zastosowania
...
public:
    ...
    void setSpecialTransform(int number);  // w��cza funkcj� specjaln� vertex shadera programowego
